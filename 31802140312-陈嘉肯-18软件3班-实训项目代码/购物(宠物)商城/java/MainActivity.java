...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.clear();
        sh.add("猫",500.00,"cat",0);
        sh.add("狗",500.00,"dog",0);
        sh.add("波斯猫",5000.00,"bosimao",0);
        sh.add("傻狗",00.00,"chaiquan",0);
        sh.add("布偶猫",3000.00,"buoumao",0);
        sh.add("土拨鼠",25,"tuboshu",0);
        sh.add("??????",9999999,"qiutianquan",0);
